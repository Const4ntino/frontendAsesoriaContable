...
// Usando la interfaz AuthResponse desde @/types/auth
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg">
                {showRegisterForm ? (
                    <RegisterForm 
                        onRegisterSuccess={(authData) => setAuth(authData)}
                        onCancel={() => setShowRegisterForm(false)}
                    />
                ) : (
                    <>
                        <h2 className="text-center text-gray-800 mb-2">Iniciar Sesión</h2>
